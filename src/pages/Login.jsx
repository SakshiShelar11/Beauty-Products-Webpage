      ...
      <div className="max-w-md mx-auto bg-white rounded-2xl shadow-2xl overflow-hidden">
        <div className="bg-gradient-to-r from-purple-600 to-pink-600 p-8 text-center">
          <h1 className="text-3xl font-bold text-white mb-2">
            {isLogin ? 'Welcome Back!' : 'Join BeautyGlam'}
          </h1>
        ...
        <div className="p-8">
          ...
          <div className="mt-6">
            ...
            <div className="mt-6 grid grid-cols-2 gap-4">
              <button className="w-full bg-white border border-gray-300 rounded-lg py-3 px-4 flex items-center justify-center text-gray-700 hover:bg-gray-50 transition duration-300">
              ...
              <button className="w-full bg-blue-600 text-white rounded-lg py-3 px-4 flex items-center justify-center hover:bg-blue-700 transition duration-300">
